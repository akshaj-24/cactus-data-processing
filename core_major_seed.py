...
df = pd.read_json("hf://datasets/Psychotherapy-LLM/CBT-Bench/core_major_seed.json")
print(df.shape)
...
model1 = OllamaLLM(base_url="localhost:11434", model="qwen3:32b", temperature=0, grammar="")
