...
df = pd.read_json("hf://datasets/Psychotherapy-LLM/CBT-Bench/core_fine_seed.json")
print(df.shape)
...
# Run all functions
jsonl_path = "core_fine_seed_results.jsonl"
csv_path = "core_fine_seed_results.csv"
xlsx_path = "core_fine_seed_results.xlsx"
log_path = "core_fine_seed_progress.txt"
